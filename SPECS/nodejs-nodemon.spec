...
# Nodejs does not ship for ix86 arches, if we tried to build this noarch package
# on such arches, the build will fail due to not having nodejs available to install.
ExcludeArch: %{ix86}
BuildArch:     noarch
